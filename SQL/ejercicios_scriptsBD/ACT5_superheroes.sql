...
INSERT INTO personajes (nombre_real, personaje, inteligencia, fuerza, velocidad, poder, aparicion, ocupacion, id_creador)
    ...
    ('Steve Rogers', 'Capitán América', 145, 600, 45, 60, 1941, 'Oficial Federal', 1),
...
SELECT nombre_real, inteligencia FROM personajes ORDER BY inteligencia ASC;