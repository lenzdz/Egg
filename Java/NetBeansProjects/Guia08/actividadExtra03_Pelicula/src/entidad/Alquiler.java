...
public class Alquiler {
    ...
    // private double precio; Aunque se pide esta variable en el ejercicio, no se usa (pues a menos que se regrese la película, no habrá precio final, y no se solicita un método para regresarla)
